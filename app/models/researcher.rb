...
return Researcher.where(:status => 1).where(:expertise => question.topic).where(:expertise != current_user).order('RANDOM()').limit(3).all #TODO - Something smarter than this please
  end
